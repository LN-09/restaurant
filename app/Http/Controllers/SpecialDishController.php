...
class SpecialDishController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($isAdmin === true) {
            ...
            $data->save();
            return redirect()->route('admin.pages.spdishes.spdishes')->with('msg', 'New Special-Dish entry created');
        }
        return redirect()->route('admin.pages.spdishes.spdishes')->with('msg', 'Can\'t create Special-Dish entry');
    }
